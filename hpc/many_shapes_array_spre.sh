...
#SBATCH --array=1-100                       # Run tasks 
#SBATCH --output=data/mujoco/results/output_many_shapes_array1_%a.log
...
# Run model
python src/simulate_model.py data/mujoco/input_many_shapes_$1.json $SLURM_ARRAY_TASK_ID
