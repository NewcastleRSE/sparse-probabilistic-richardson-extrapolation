...
#SBATCH --output=data/physics_quick/results/output_physics_quick_true2_val.log
...
python src/simulate_model.py data/physics_quick/input_physics_quick_true2.json 1
