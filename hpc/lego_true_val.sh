...
#SBATCH --output=data/physics_quick/results/output_physics_quick_true_val.log
...
python src/simulate_model.py data/physics_quick/input_physics_quick_true.json 1
