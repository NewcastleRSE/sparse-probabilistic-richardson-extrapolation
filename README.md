...
There is some code documentation automatically created from the docstrings (comments for methods etc.) that is available in `site\index.html` or on GitHub pages [here](https://newcastlerse.github.io/sparse-probabilistic-richardson-extrapolation/) which may be useful.
